...
export const ftwzLocationDetails: FTWZLocationDetail[] = [
  ...
  },
  {
    ...
    seo: {
      title: "FTWZ Warehouse Mundra | Adani Ports APSEZ Gujarat | Astromar",
      description: "Duty-free FTWZ warehousing at Mundra, India's largest commercial port (APSEZ). Strategic gateway for trade with the Middle East, Africa, and Europe with bulk and container capabilities.",
      keywords: "FTWZ Mundra, Mundra port warehouse, APSEZ duty free zone, Adani Ports SEZ Gujarat, Mundra container logistics",
    },
    portOverview: {
