  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@type": "BreadcrumbList",
        itemListElement: [
          { "@type": "ListItem", position: 1, name: "Home", item: "https://astromarlogistics.com/" },
          { "@type": "ListItem", position: 2, name: "FTWZ Services", item: "https://astromarlogistics.com/ftwz-services" },
          { "@type": "ListItem", position: 3, name: `FTWZ ${location.city}`, item: `https://astromarlogistics.com/locations/${location.slug}` },
        ],
      }) }} />
      <Header />
          ...
          <ScrollReveal delay={0.1}>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                ...(location.portOverview.operatedBy.toLowerCase().includes("astromar")
                  ? [{ label: "Operated By", value: location.portOverview.operatedBy }]
                  : []),
